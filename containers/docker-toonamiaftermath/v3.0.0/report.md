...
| Test | Result |
| ----------------------- | --- |
| Selenium ubuntu-18-v3.0.0 | FAIL DRIVER ERROR |
| Screenshot ubuntu-18-v3.0.0 | PASSED |
| Test Init Scripts for: ubuntu-18-v3.0.0 | PASSED |
| Test Service Scripts for: ubuntu-18-v3.0.0 | PASSED |
...
## christopher102994/docker-toonamiaftermath:ubuntu-18-v3.0.0

[![ubuntu-18-v3.0.0](ubuntu-18-v3.0.0.png =600x*)](ubuntu-18-v3.0.0.png)

### Build Version: ubuntu-18-v3.0.0
...
# FOLDER PERMISSIONS:
-------------------------
drwxr-xr-x 1 user user 4096 Feb 18 20:51 /app
drwxr-xr-x 4 user user 4096 Feb 18 21:01 /config
drwxr-xr-x 1 user user 4096 Feb 18 20:51 /defaults
-------------------------

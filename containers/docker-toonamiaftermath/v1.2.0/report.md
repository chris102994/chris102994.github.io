...
| Test | Result |
| ----------------------- | --- |
| Screenshot alpine-3.10-v1.2.0 | PASSED |
| Test Init Scripts for: alpine-3.10-v1.2.0 | PASSED |
| Test Service Scripts for: alpine-3.10-v1.2.0 | PASSED |
...
## christopher102994/docker-toonamiaftermath:alpine-3.10-v1.2.0

[![alpine-3.10-v1.2.0](alpine-3.10-v1.2.0.png =600x*)](alpine-3.10-v1.2.0.png)

### Build Version: alpine-3.10-v1.2.0
...
# FOLDER PERMISSIONS:
-------------------------
drwxr-xr-x 1 user user 4096 Sep 17 23:21 /app
drwxr-xr-x 4 user user 4096 Sep 17 23:23 /config
drwxr-xr-x 1 user user 4096 Sep 17 23:21 /defaults
-------------------------

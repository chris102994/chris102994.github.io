...
| Test | Result |
| ----------------------- | --- |
| Screenshot alpine-3.10-v1.0.1 | PASSED |
...
## christopher102994/docker-arconaitv:alpine-3.10-v1.0.1

[![alpine-3.10-v1.0.1](alpine-3.10-v1.0.1.png =600x*)](alpine-3.10-v1.0.1.png)
...
# FOLDER PERMISSIONS:
-------------------------
drwxr-xr-x 1 user user 4096 May  5 20:58 /app
drwxr-xr-x 4 user user 4096 May  5 20:59 /config
drwxr-xr-x 1 user user 4096 May  5 20:58 /defaults
-------------------------
...
Traceback (most recent call last):
  File "/app/ArconaiTV/ArconaiTV/__init__.py", line 14, in <module>
    main()
  File "/app/ArconaiTV/ArconaiTV/__init__.py", line 8, in main
    media_list = scraper.get_media()
  File "/app/ArconaiTV/ArconaiTV/arconai_tv.py", line 114, in get_media
    show_list = self.list_media('shows')
  File "/app/ArconaiTV/ArconaiTV/arconai_tv.py", line 97, in list_media
    media_info = self.get_media_info(type, title)
  File "/app/ArconaiTV/ArconaiTV/arconai_tv.py", line 39, in get_media_info
    data = open(full_path).read()
FileNotFoundError: [Errno 2] No such file or directory: '/home/chris/Workspace/Docker/docker-arconaitv/rootfs/app/ArconaiTV/ArconaiTV/data/shows.json'
